...
#ifndef LIS2DS12_H_INCLUDED
#define LIS2DS12_H_INCLUDED
/* Includes ------------------------------------------------------------------*/
/* Exported types ------------------------------------------------------------*/
...
/************** I2C Address *****************/
#define LIS2DS12_I2C_ADDRESS         0x1E
...
/************** Device Register  *******************/
#define LIS2DS12_SENSORHUB_OUT1  	0X06
#define LIS2DS12_SENSORHUB_OUT2  	0X07
#define LIS2DS12_SENSORHUB_OUT3  	0X08
#define LIS2DS12_SENSORHUB_OUT4  	0X09
#define LIS2DS12_SENSORHUB_OUT5  	0X0A
#define LIS2DS12_SENSORHUB_OUT6  	0X0B
#define LIS2DS12_MODULE_8BIT  	0X0C
#define LIS2DS12_WHO_AM_I_REG  	0X0F
...
#define LIS2DS12_STEP_C_MINTHS  	0X3A
#define LIS2DS12_STEP_C_L  	0X3B
#define LIS2DS12_STEP_C_H  	0X3C
...
* Permission    : RO
*******************************************************************************/
#define  	LIS2DS12_MODULE8_BIT_MASK  	0xFF
#define  	LIS2DS12_MODULE8_BIT_POSITION  	0
...
* Permission    : RO
*******************************************************************************/
#define  	LIS2DS12_WHO_AM_I_BIT_MASK  	0xFF
#define  	LIS2DS12_WHO_AM_I_BIT_POSITION  	0
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_BDU_OFF 		 =0x00,
  	LIS2DS12_BDU_ON 		 =0x01,
} LIS2DS12_BDU_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_HF_ODR_OFF 		 =0x00,
  	LIS2DS12_HF_ODR_ON 		     =0x02,
} LIS2DS12_HF_ODR_t;
...
*******************************************************************************/
typedef enum {
	LIS2DS12_ODR_PowerDown 		    =0x00,
	LIS2DS12_ODR_HR_14bit_12_5Hz	=0x10,
	LIS2DS12_ODR_HR_14bit_25Hz		=0x20,
	LIS2DS12_ODR_HR_14bit_50Hz		=0x30,
	LIS2DS12_ODR_HR_14bit_100Hz		=0x40,
	LIS2DS12_ODR_HR_14bit_200Hz		=0x50, /* if HF is on it is HF_12b@1600Hz*/
	LIS2DS12_ODR_HR_14bit_400Hz		=0x60, /* if HF is on it is HF_12b@3200Hz*/
	LIS2DS12_ODR_HR_14bit_800Hz		=0x70, /* if HF is on it is HF_12b@6400Hz*/
	LIS2DS12_ODR_LP_10bit_1Hz		=0x80,
	LIS2DS12_ODR_LP_10bit_12_5Hz	=0x90,
	LIS2DS12_ODR_LP_10bit_25Hz		=0xA0,
	LIS2DS12_ODR_LP_10bit_50Hz		=0xB0,
	LIS2DS12_ODR_LP_10bit_100Hz 	=0xC0,
	LIS2DS12_ODR_LP_10bit_200Hz		=0xD0,
	LIS2DS12_ODR_LP_10bit_400Hz		=0xE0,
	LIS2DS12_ODR_LP_10bit_800Hz		=0xF0,
} LIS2DS12_ODR_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SIM_4_wire 		 =0x00,
  	LIS2DS12_SIM_3_wire 		 =0x01,
} LIS2DS12_SIM_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_I2C_DISABLE_OFF 		 =0x00,
  	LIS2DS12_I2C_DISABLE_ON 		 =0x02,
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_IF_ADD_INC_OFF 		 =0x00,
  	LIS2DS12_IF_ADD_INC_ON 		     =0x04,
} LIS2DS12_IF_ADD_INC_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FDS_SLOPE_OFF 		 =0x00,
  	LIS2DS12_FDS_SLOPE_ON 		 =0x08,
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SOFT_RESET_OFF 		 =0x00,
  	LIS2DS12_SOFT_RESET_ON 		     =0x40,
} LIS2DS12_SOFT_RESET_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_BOOT_OFF 		 =0x00,
  	LIS2DS12_BOOT_ON 		 =0x80,
} LIS2DS12_BOOT_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_PP_OD_push_pull 		 =0x00,
  	LIS2DS12_PP_OD_open_drain 		 =0x01,
} LIS2DS12_PP_OD_t;

#define  	LIS2DS12_PP_OD_MASK  	0x01
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_H_LACTIVE_high      =0x00,
  	LIS2DS12_H_LACTIVE_low 		 =0x02,
} LIS2DS12_H_LACTIVE_t;

#define  	LIS2DS12_H_LACTIVE_MASK  	0x02
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_LIR_OFF 		 =0x00,
  	LIS2DS12_LIR_ON 		 =0x04,
} LIS2DS12_LIR_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TAP_Z_EN_OFF 		 =0x00,
  	LIS2DS12_TAP_Z_EN_ON 		 =0x08,
} LIS2DS12_TAP_Z_EN_t;

#define  	LIS2DS12_TAP_Z_EN_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TAP_Y_EN_OFF 		 =0x00,
  	LIS2DS12_TAP_Y_EN_ON 		 =0x10,
} LIS2DS12_TAP_Y_EN_t;

#define  	LIS2DS12_TAP_Y_EN_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TAP_X_EN_OFF 		 =0x00,
  	LIS2DS12_TAP_X_EN_ON 		 =0x20,
} LIS2DS12_TAP_X_EN_t;

#define  	LIS2DS12_TAP_X_EN_MASK  	0x20
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_DRDY_OFF 		 =0x00,
  	LIS2DS12_INT1_DRDY_ON 		 =0x01,
} LIS2DS12_INT1_DRDY_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_FTH_OFF 		 =0x00,
  	LIS2DS12_INT1_FTH_ON 		 =0x02,
} LIS2DS12_INT1_FTH_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_6D_OFF 		 =0x00,
  	LIS2DS12_INT1_6D_ON 		 =0x04,
} LIS2DS12_INT1_6D_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_TAP_OFF 		 =0x00,
  	LIS2DS12_INT1_TAP_ON 		 =0x08,
} LIS2DS12_INT1_TAP_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_FF_OFF 		 =0x00,
  	LIS2DS12_INT1_FF_ON 		 =0x10,
} LIS2DS12_INT1_FF_t;

#define  	LIS2DS12_INT1_FF_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_WU_OFF 		 =0x00,
  	LIS2DS12_INT1_WU_ON 		 =0x20,
} LIS2DS12_INT1_WU_t;

#define  	LIS2DS12_INT1_WU_MASK  	0x20
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_S_TAP_OFF 		 =0x00,
  	LIS2DS12_INT1_S_TAP_ON 		 =0x40,
} LIS2DS12_INT1_S_TAP_t;
...
* Register      : CTRL4
* Address       : 0X23
* Bit Group Name: INT1_MASTER_DRDY
* Permission    : RW
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_MASTER_DRDY_OFF 		 =0x00,
  	LIS2DS12_INT1_MASTER_DRDY_ON 		 =0x80,
} LIS2DS12_INT1_MASTER_DRDY_t;

#define  	LIS2DS12_INT1_MASTER_DRDY_MASK  	0x80
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT2_DRDY_OFF 		 =0x00,
  	LIS2DS12_INT2_DRDY_ON 		 =0x01,
} LIS2DS12_INT2_DRDY_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT2_FTH_OFF 		 =0x00,
  	LIS2DS12_INT2_FTH_ON 		 =0x02,
} LIS2DS12_INT2_FTH_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT2_STEP_DET_OFF 		 =0x00,
  	LIS2DS12_INT2_STEP_DET_ON 		 =0x04,
} LIS2DS12_INT2_STEP_DET_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT2_SIG_MOT_OFF 		 =0x00,
  	LIS2DS12_INT2_SIG_MOT_ON 		 =0x08,
} LIS2DS12_INT2_SIG_MOT_t;

#define  	LIS2DS12_INT2_SIG_MOT_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT2_TILT_OFF 		 =0x00,
  	LIS2DS12_INT2_TILT_ON 		 =0x10,
} LIS2DS12_INT2_TILT_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT2_ON_INT1_OFF 		 =0x00,
  	LIS2DS12_INT2_ON_INT1_ON 		 =0x20,
} LIS2DS12_INT2_ON_INT1_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT2_BOOT_OFF 		 =0x00,
  	LIS2DS12_INT2_BOOT_ON 		 =0x40,
} LIS2DS12_INT2_BOOT_t;

#define  	LIS2DS12_INT2_BOOT_MASK  	0x40
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_DRDY_PULSED_OFF 		 =0x00,
  	LIS2DS12_DRDY_PULSED_ON 		 =0x80,
} LIS2DS12_DRDY_PULSED_t;

#define  	LIS2DS12_DRDY_PULSED_MASK  	0x80
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_IF_CS_PU_DIS_OFF 		 =0x00,
  	LIS2DS12_IF_CS_PU_DIS_ON 		 =0x01,
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_MODULE_TO_FIFO_OFF 		 =0x00,
  	LIS2DS12_MODULE_TO_FIFO_ON 		 =0x08,
} LIS2DS12_MODULE_TO_FIFO_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FMODE_BYPASS 		 =0x00,
  	LIS2DS12_FMODE_FIFO 		 =0x20,
  	LIS2DS12_FMODE_STF	 		 =0x60,
  	LIS2DS12_FMODE_BTS 			 =0x80,
  	LIS2DS12_FMODE_STREAM 		 =0xC0,
} LIS2DS12_FMODE_t;
...
* Permission    : RO
*******************************************************************************/
#define  	LIS2DS12_TEMP_BIT_MASK  	0xFF
#define  	LIS2DS12_TEMP_BIT_POSITION  	0
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_DRDY_EV_OFF 		 =0x00,
  	LIS2DS12_DRDY_EV_ON 		 =0x01,
} LIS2DS12_DRDY_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FF_IA_EV_OFF 		 =0x00,
  	LIS2DS12_FF_IA_EV_ON 		 =0x02,
} LIS2DS12_FF_IA_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_6D_IA_EV_OFF 		 =0x00,
  	LIS2DS12_6D_IA_EV_ON 		 =0x04,
} LIS2DS12_6D_IA_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SINGLE_TAP_EV_OFF 		 =0x00,
  	LIS2DS12_SINGLE_TAP_EV_ON 		 =0x08,
} LIS2DS12_SINGLE_TAP_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_DOUBLE_TAP_EV_OFF 		 =0x00,
  	LIS2DS12_DOUBLE_TAP_EV_ON 		 =0x10,
} LIS2DS12_DOUBLE_TAP_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SLEEP_STATE_EV_OFF 		 =0x00,
  	LIS2DS12_SLEEP_STATE_EV_ON 		 =0x20,
} LIS2DS12_SLEEP_STATE_t;

#define  	LIS2DS12_SLEEP_STATE_MASK  	0x20
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_WU_IA_EV_OFF 		 =0x00,
  	LIS2DS12_WU_IA_EV_ON 		 =0x40,
} LIS2DS12_WU_IA_t;

#define  	LIS2DS12_WU_IA_MASK  	0x40
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FIFO_THS_EV_OFF 		 =0x00,
  	LIS2DS12_FIFO_THS_EV_ON 		 =0x80,
} LIS2DS12_FIFO_THS_t;
...
* Permission    : RW
*******************************************************************************/
#define  	LIS2DS12_FTH_MASK  	0xFF
#define  	LIS2DS12_FTH_POSITION  	0
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FIFO_OVR_EV_OFF 		 =0x00,
  	LIS2DS12_FIFO_OVR_EV_ON 		 =0x40,
} LIS2DS12_FIFO_OVR_t;

#define  	LIS2DS12_FIFO_OVR_MASK  	0x40
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FTH_EV_OFF 		 =0x00,
  	LIS2DS12_FTH_EV_ON 		 =0x80,
} LIS2DS12_FTH_STATUS_t;

#define  	LIS2DS12_FTH_STATUS_MASK  	0x80
...
* Permission    : RW
*******************************************************************************/
#define  	LIS2DS12_SAMPLE_L_MASK  	0xFF
#define  	LIS2DS12_SAMPLE_L_POSITION  	0
#define  	LIS2DS12_SAMPLE_H_MASK  	0x20
#define  	LIS2DS12_SAMPLE_H_POSITION  	5
...
#define  	LIS2DS12_TAP_THS_POSITION  	0
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_6D_THS_80_degrees 		 =0x00,
  	LIS2DS12_6D_THS_70_degrees 		 =0x20,
  	LIS2DS12_6D_THS_60_degrees 		 =0x40,
  	LIS2DS12_6D_THS_50_degrees 		 =0x60,
} LIS2DS12_6D_THS_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_4D_EN_OFF 		 =0x00,
  	LIS2DS12_4D_EN_ON 		 =0x80,
} LIS2DS12_4D_EN_t;

#define  	LIS2DS12_4D_EN_MASK  	0x80
...
#define  	LIS2DS12_SHOCK_POSITION  	0
...
#define  	LIS2DS12_QUIET_POSITION  	2
...
#define  	LIS2DS12_LAT_POSITION  	4
...
* Permission    : RW
*******************************************************************************/
#define  	LIS2DS12_WU_THS_MASK  	0x3F
#define  	LIS2DS12_WU_THS_POSITION  	0
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SLEEP_ON_OFF 		 =0x00,
  	LIS2DS12_SLEEP_ON_ON 		 =0x40,
} LIS2DS12_SLEEP_ON_t;

#define  	LIS2DS12_SLEEP_ON_MASK  	0x40
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SINGLE_DOUBLE_TAP_EV_OFF 		 =0x00,
  	LIS2DS12_SINGLE_DOUBLE_TAP_EV_ON 		 =0x80,
} LIS2DS12_SINGLE_DOUBLE_TAP_t;

#define  	LIS2DS12_SINGLE_DOUBLE_TAP_MASK  	0x80
...
#define  	LIS2DS12_SLEEP_DUR_POSITION  	0
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_INT1_FIFO_FULL_OFF 		 =0x00,
  	LIS2DS12_INT1_FIFO_FULL_ON 		 =0x10,
} LIS2DS12_INT1_FIFO_FULL_t;

#define  	LIS2DS12_INT1_FIFO_FULL_MASK  	0x10
...
#define  	LIS2DS12_WU_DUR_POSITION  	5
...
#define  	LIS2DS12_FF_THS_POSITION  	0
...
* Permission    : RW
*******************************************************************************/
#define  	LIS2DS12_FF_DUR_LOW_MASK  	0xF8
#define  	LIS2DS12_FF_DUR_LOW_POSITION  	3
#define  	LIS2DS12_FF_DUR_HIGH_MASK  	0x80
#define  	LIS2DS12_FF_DUR_HIGH_POSITION  	7
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_DRDY_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_DRDY_EV_DUP_ON 		 =0x01,
} LIS2DS12_DRDY_DUP_t;

#define  	LIS2DS12_DRDY_DUP_MASK  	0x01
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FF_IA_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_FF_IA_EV_DUP_ON 		 =0x02,
} LIS2DS12_FF_IA_DUP_t;

#define  	LIS2DS12_FF_IA_DUP_MASK  	0x02
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_6D_IA_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_6D_IA_EV_DUP_ON 		 =0x04,
} LIS2DS12_6D_IA_DUP_t;

#define  	LIS2DS12_6D_IA_DUP_MASK  	0x04
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SINGLE_TAP_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_SINGLE_TAP_EV_vON 		 =0x08,
} LIS2DS12_SINGLE_TAP_DUP_t;

#define  	LIS2DS12_SINGLE_TAP_DUP_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_DOUBLE_TAP_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_DOUBLE_TAP_EV_DUP_ON 		 =0x10,
} LIS2DS12_DOUBLE_TAP_DUP_t;

#define  	LIS2DS12_DOUBLE_TAP_DUP_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SLEEP_STATE_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_SLEEP_STATE_EV_DUP_ON 		 =0x20,
} LIS2DS12_SLEEP_STATE_DUP_t;

#define  	LIS2DS12_SLEEP_STATE_DUP_MASK  	0x20
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_WU_IA_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_WU_IA_EV_DUP_ON 		 =0x40,
} LIS2DS12_WU_IA_DUP_t;

#define  	LIS2DS12_WU_IA_DUP_MASK  	0x40
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_OVR_EV_DUP_OFF 		 =0x00,
  	LIS2DS12_OVR_EV_DUP_ON 		 =0x80,
} LIS2DS12_OVR_DUP_t;

#define  	LIS2DS12_OVR_DUP_MASK  	0x80
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_Z_WU_EV_OFF 		 =0x00,
  	LIS2DS12_Z_WU_EV_ON 		 =0x01,
} LIS2DS12_Z_WU_t;

#define  	LIS2DS12_Z_WU_MASK  	0x01
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_Y_WU_EV_OFF 		 =0x00,
  	LIS2DS12_Y_WU_EV_ON 		 =0x02,
} LIS2DS12_Y_WU_t;

#define  	LIS2DS12_Y_WU_MASK  	0x02
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_X_WU_EV_OFF 		 =0x00,
  	LIS2DS12_X_WU_EV_ON 		 =0x04,
} LIS2DS12_X_WU_t;

#define  	LIS2DS12_X_WU_MASK  	0x04
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_WU_IA_DUP2_EV_OFF 		 =0x00,
  	LIS2DS12_WU_IA_DUP2_EV_ON 		 =0x08,
} LIS2DS12_WU_IA_DUP2_t;

#define  	LIS2DS12_WU_IA_DUP2_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SLEEP_STATE_IA_EV_OFF 		 =0x00,
  	LIS2DS12_SLEEP_STATE_IA_EV_ON 		 =0x10,
} LIS2DS12_SLEEP_STATE_IA_t;

#define  	LIS2DS12_SLEEP_STATE_IA_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FF_IA_DUP2_EV_OFF 		 =0x00,
  	LIS2DS12_FF_IA_DUP2_EV_ON 		 =0x20,
} LIS2DS12_FF_IA_DUP2_t;

#define  	LIS2DS12_FF_IA_DUP2_MASK  	0x20
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_Z_TAP_EV_OFF 		 =0x00,
  	LIS2DS12_Z_TAP_EV_ON 		 =0x01,
} LIS2DS12_Z_TAP_t;

#define  	LIS2DS12_Z_TAP_MASK  	0x01
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_Y_TAP_EV_OFF 		 =0x00,
  	LIS2DS12_Y_TAP_EV_ON 		 =0x02,
} LIS2DS12_Y_TAP_t;

#define  	LIS2DS12_Y_TAP_MASK  	0x02
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_X_TAP_EV_OFF 		 =0x00,
  	LIS2DS12_X_TAP_EV_ON 		 =0x04,
} LIS2DS12_X_TAP_t;

#define  	LIS2DS12_X_TAP_MASK  	0x04
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TAP_SIGN_EV_OFF 		 =0x00,
  	LIS2DS12_TAP_SIGN_EV_ON 		 =0x08,
} LIS2DS12_TAP_SIGN_t;

#define  	LIS2DS12_TAP_SIGN_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_DOUBLE_TAP_DUP2_EV_OFF 		 =0x00,
  	LIS2DS12_DOUBLE_TAP_DUP2_EV_ON 		 =0x10,
} LIS2DS12_DOUBLE_TAP_DUP2_t;

#define  	LIS2DS12_DOUBLE_TAP_DUP2_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SINGLE_TAP_DUP2_EV_OFF 		 =0x00,
  	LIS2DS12_SINGLE_TAP_DUP2_EV_ON 		 =0x20,
} LIS2DS12_SINGLE_TAP_DUP2_t;

#define  	LIS2DS12_SINGLE_TAP_DUP2_MASK  	0x20
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TAP_IA_EV_OFF 		 =0x00,
  	LIS2DS12_TAP_IA_EV_ON 		 =0x40,
} LIS2DS12_TAP_IA_t;

#define  	LIS2DS12_TAP_IA_MASK  	0x40
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_XL_EV_OFF 		 =0x00,
  	LIS2DS12_XL_EV_ON 		 =0x01,
} LIS2DS12_XL_t;

#define  	LIS2DS12_XL_MASK  	0x01
...
*******************************************************************************/
typedef enum {
    LIS2DS12_XH_EV_OFF       =0x00,
    LIS2DS12_XH_EV_ON        =0x02,
} LIS2DS12_XH_t;

#define     LIS2DS12_XH_MASK    0x02
...
*******************************************************************************/
typedef enum {
    LIS2DS12_YL_EV_OFF       =0x00,
    LIS2DS12_YL_EV_ON        =0x04,
} LIS2DS12_YL_t;

#define     LIS2DS12_YL_MASK    0x04
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_YH_EV_OFF 		 =0x00,
  	LIS2DS12_YH_EV_ON 		 =0x08,
} LIS2DS12_YH_t;

#define  	LIS2DS12_YH_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_ZL_EV_OFF 		 =0x00,
  	LIS2DS12_ZL_EV_ON 		 =0x10,
} LIS2DS12_ZL_t;

#define  	LIS2DS12_ZL_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_ZH_EV_OFF 		 =0x00,
  	LIS2DS12_ZH_EV_ON 		 =0x20,
} LIS2DS12_ZH_t;

#define  	LIS2DS12_ZH_MASK  	0x20
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_6D_IA_EV_DUP2_OFF 		 =0x00,
  	LIS2DS12_6D_IA_DUP2_EV_ON 		 =0x40,
} LIS2DS12_6D_IA_DUP2_t;

#define  	LIS2DS12_6D_IA_DUP2_MASK  	0x40
...
#define  	LIS2DS12_SC_MTHS_POSITION  	0
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_PEDO4G_OFF 		 =0x00,
  	LIS2DS12_PEDO4G_ON 		 =0x40,
} LIS2DS12_PEDO4G_t;

#define  	LIS2DS12_PEDO4G_MASK  	0x40
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_RST_NSTEP_OFF 		 =0x00,
  	LIS2DS12_RST_NSTEP_ON 		 =0x80,
} LIS2DS12_RST_NSTEP_t;

#define  	LIS2DS12_RST_NSTEP_MASK  	0x80
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_CK_GATE_FUNC_OFF 		 =0x00,
  	LIS2DS12_CK_GATE_FUNC_ON 		 =0x01,
} LIS2DS12_CK_GATE_FUNC_t;

#define  	LIS2DS12_CK_GATE_FUNC_MASK  	0x01
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_STEP_DETECT_EV_OFF 		 =0x00,
  	LIS2DS12_STEP_DETECT_EV_ON 		 =0x02,
} LIS2DS12_STEP_DETECT_t;

#define  	LIS2DS12_STEP_DETECT_MASK  	0x02
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_RST_PEDO_OFF 		 =0x00,
  	LIS2DS12_RST_PEDO_ON 		 =0x04,
} LIS2DS12_RST_PEDO_t;

#define  	LIS2DS12_RST_PEDO_MASK  	0x04
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_RST_SIGN_MOT_OFF 		 =0x00,
  	LIS2DS12_RST_SIGN_MOT_ON 		 =0x08,
} LIS2DS12_RST_SIGN_MOT_t;

#define  	LIS2DS12_RST_SIGN_MOT_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SIG_MOT_DETECT_EV_OFF 		 =0x00,
  	LIS2DS12_SIG_MOT_DETECT_EV_ON 		 =0x10,
} LIS2DS12_SIG_MOT_DETECT_t;

#define  	LIS2DS12_SIG_MOT_DETECT_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_FS_SRC_NO_SCALING 		 =0x00,
  	LIS2DS12_FS_SRC_2G 		 =0x20,
  	LIS2DS12_FS_SRC_4G 		 =0x40,
  	LIS2DS12_FS_SRC_NO_SCALING2 		 =0x60,
} LIS2DS12_FS_SRC_t;
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TILT_INT_EV_OFF 		 =0x00,
  	LIS2DS12_TILT_INT_EV_ON 		 =0x80,
} LIS2DS12_TILT_INT_t;

#define  	LIS2DS12_TILT_INT_MASK  	0x80
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SENS_HUB_END_OP_EV_OFF 		 =0x00,
  	LIS2DS12_SENS_HUB_END_OP_EV_ON 		 =0x01,
} LIS2DS12_SENS_HUB_END_OP_t;

#define  	LIS2DS12_SENS_HUB_END_OP_MASK  	0x01
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_MODULE_READY_EV_OFF 		 =0x00,
  	LIS2DS12_MODULE_READY_EV_ON 		 =0x02,
} LIS2DS12_MODULE_READY_t;

#define  	LIS2DS12_MODULE_READY_MASK  	0x02
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_RST_TILT_OFF 		 =0x00,
  	LIS2DS12_RST_TILT_ON 		 =0x04,
} LIS2DS12_RST_TILT_t;

#define  	LIS2DS12_RST_TILT_MASK  	0x04
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_STEP_CNT_ON_OFF 		 =0x00,
  	LIS2DS12_STEP_CNT_ON_ON 		 =0x01,
} LIS2DS12_STEP_CNT_ON_t;

#define  	LIS2DS12_STEP_CNT_ON_MASK  	0x01
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_SIGN_MOT_ON_OFF 		 =0x00,
  	LIS2DS12_SIGN_MOT_ON_ON 		 =0x02,
} LIS2DS12_SIGN_MOT_ON_t;

#define  	LIS2DS12_SIGN_MOT_ON_MASK  	0x02
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_MASTER_ON_OFF 		 =0x00,
  	LIS2DS12_MASTER_ON_ON 		 =0x04,
} LIS2DS12_MASTER_ON_t;

#define  	LIS2DS12_MASTER_ON_MASK  	0x04
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TUD_EN_OFF 		 =0x00,
  	LIS2DS12_TUD_EN_ON 		 =0x08,
} LIS2DS12_TUD_EN_t;

#define  	LIS2DS12_TUD_EN_MASK  	0x08
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_TILT_ON_OFF 		 =0x00,
  	LIS2DS12_TILT_ON_ON 		 =0x10,
} LIS2DS12_TILT_ON_t;

#define  	LIS2DS12_TILT_ON_MASK  	0x10
...
*******************************************************************************/
typedef enum {
  	LIS2DS12_MODULE_ON_OFF 		 =0x00,
  	LIS2DS12_MODULE_ON_ON 		 =0x20,
} LIS2DS12_MODULE_ON_t;

#define  	LIS2DS12_MODULE_ON_MASK  	0x20
