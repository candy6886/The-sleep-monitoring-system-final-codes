 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/wu/workspace_v7/1_TI regulator and translator INT no BLE/Debug/configPkg/package/cfg/main_pem3");
...
#endif
#endif
const ti_sysbios_knl_Semaphore_Handle gSensorSem = (ti_sysbios_knl_Semaphore_Handle)
           ((ti_sysbios_knl_Semaphore_Handle)&ti_sysbios_knl_Semaphore_Object__table__V[0]);
